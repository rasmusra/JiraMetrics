...
Scenario Outline: Different start and end date combinations 
	...
	| Started, but without the started-flag        | OFU-676  | Defect                      | Re-filtering page leaves you on same "page number" as previously - should go to first page | 2013-02-25 09:41:34 | 2013-02-27 16:49:34 | 2,30       | 1,0          |
	...
	| Started before the "started" label was added | OFU-2290 | Defect Sub-Task             | Incorrect position of the Advanced Filter header                                           | 2014-08-27 09:08:33 | 2014-12-18 07:45:20 | 112,94     | 1,0          |
