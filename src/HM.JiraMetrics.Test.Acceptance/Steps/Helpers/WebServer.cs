...
namespace HM.JiraMetrics.Test.Acceptance.Steps.Helpers
{
    internal class WebServer
    {
        ...
        private static readonly FileInfo FakeStructureMapConfigFileInfo = new FileInfo(@"..\..\..\HM.JiraMetrics.Test.Fakes\FakeStructureMap.xml");
        private static readonly FileInfo StructureMapConfig = new FileInfo(@"..\..\..\HM.JiraMetrics.Web\StructureMap.xml");
        private static readonly FileInfo StructureMapConfigBackup = new FileInfo(@"..\..\..\HM.JiraMetrics.Web\StructureMap.xml.backup");
